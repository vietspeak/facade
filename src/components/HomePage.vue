            ...
            <div class="header-wrapper" id="header-wrapper">
                ...
                <div class="header-right">
                    ...
                    <div class="header-btn">
                        <a class="rn-btn" href="https://airtable.com/shr9lanI3t9jJ3STm">
                            <span>Tham gia với chúng tớ!</span>
                        </a>
                    </div>
                    ...
                    <div class="container">
                        <div class="row row--35 align-items-center">
                            <div class="col-lg-5 col-md-12">
                                <div class="thumbnail">
                                    <img class="w-100" src="assets/images/about/about-1.jpg" alt="About Images" />
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="rn-counterup counterup_style--1">
                                <h5 class="counter count">22</h5>
                                <p class="description">Tổng số task đã thực hiện...</p>
                            </div>
                        </div>
                        <!-- Start Single Counterup  -->
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="rn-counterup counterup_style--1">
                                <h5 class="counter count">1500</h5>
                                <p class="description">Tổng số thành viên đã tham gia từ trước đến nay.</p>
                            </div>
                        </div>
                        <!-- Start Single Counterup  -->
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="rn-counterup counterup_style--1">
                                ...
                                <p class="description">Hãy nói về học phí học đồ một tí đi?</p>
                            </div>
                        </div>
                        <!-- Start Single Counterup  -->
                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="rn-testimonial-content tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                    <div class="inner">
                                        <p>Việt Speak giúp mình phát hiện và chữa lỗi hay dã man.</p>
                                    </div>
                                    <div class="author-info">
            ...
            <div class="rn-blog-area rn-section-gapTop bg_color--1">
                <div class="container">
                    <div class="row align-items-end mb--20">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="blog-btn text-left text-lg-right mt_sm--10 mt_md--10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-12 mt_mobile--30">
                                    <div class="footer-widget">
                                        <h4>Say Hello</h4>
                                        <ul class="ft-link">
                                            <li><a href="mailto:admin@example.com">contact@vietspeak.org</a></li>                                           
                                        </ul>
                                ...
                                <div class="col-lg-12">
                                    <div class="copyright-text">
                                        <p>Copyright © 2020 Việt Speak. Bảo lưu mọi bản quyền.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
